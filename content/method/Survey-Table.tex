...
\multirow{3}{*}{Srinivasan~\textit{et~al.}~\cite{Srinivasan2014, srinivasan2014oct-repoICPR}} & \gls{bm3d} & \multirow{3}{*}{\gls{hog}} & \multirow{3}{*}{Global} & &  Linear- \\
 & Flattening & & & &\gls{svm} \\
 & Cropping & & & & \\
	&  &  &  &  & \\
%Lema\^itre~\textit{et~al.}~
\multirow{3}{*}{Lemaitre~\textit{et~al.}~\cite{Lemaintre2015miccaiOCT, lemaitre2015apr-repoICPR}} & \multirow{3}{*}{\gls{nlm}} & \gls{lbp} & Local &  \gls{pca} &  \multirow{3}{*}{\gls{rf}} \\
& & \gls{lbptop} & Global & \gls{bow}& \\
	&  &  &  &Histogram & \\
&  &  &  &  & \\

\multirow{3}{*}{Alsaih~\textit{et~al.}~\cite{Alsaih2016apr-repoICPR}} & \gls{bm3d} & \gls{lbp} & \multirow{3}{*}{Local} &  \gls{pca} &  Linear- \\
...
%\midrule
\hdashline \noalign{\vskip 3pt}
\multirow{3}{*}{Sankar~\textit{et~al.}~\cite{sankar2016classification, sankar2015feb-repoICPR}} & \gls{nlm} & Pixel & \multirow{3}{*}{Global} & \multirow{3}{*	}{\gls{pca}} & Mahalanobis \\

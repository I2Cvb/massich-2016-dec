...
\toprule
Ref & Data  & \multicolumn{4}{c}{Pre-processing} & Features &  Mapping &  Representation & Classification\\
    & size &  &  &  &  &  &  &  & \\
   \cmidrule(l){3-6} 
...
Srinivasab\,\textit{et al.}~\cite{Srinivasan2014} &  45 & $\checkmark$ & $\checkmark$ &  & $\checkmark$ & \gls{hog} & Global & linear-\gls{svm} \\
& & & & & & & & & \\
...
%\midrule
\hdashline \noalign{\vskip 3pt}
Sankar\,\textit{et al.}~\cite{sankar2016classification} & 32 & $\checkmark$ & $\checkmark$& & $\checkmark$ & intensities & Global & \gls{gmm} & Mahalanobis \\
 & & & & & & -pixels & & & -distance\\
\bottomrule
\end{tabular}}}

...
All the experiments are evaluated in terms of \gls{se} and \gls{sp} (see Fig.\,\ref{fig:evaluation}) using the \gls{lopocv} strategy, in line with \cite{Lemaintre2015miccaiOCT}.

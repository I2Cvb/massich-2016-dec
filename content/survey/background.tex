...
%This section reviews, up to our knowledge, the works straightly addressing the problem of classifying \gls{oct} volume as normal or abnormal. A summary can be found in \Cref{tab:survey}.

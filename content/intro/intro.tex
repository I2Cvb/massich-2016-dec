...
Fundus photography and \ac{oct} imaging are the two major screening techniques used for detection of such diseases.
...
The latest generation of this technique, namely \ac{sdoct} offers high resolution of \ac{oct}.

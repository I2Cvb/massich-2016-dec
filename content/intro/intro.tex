...
%It is easy to miss some pathology signs as well.
%Evaluation of the volumetric scan is time consuming, expensive and some pathology signs are easy to miss~\cite{Venhuizen2015}
...
This article is structured as follows, Sect.\,\ref{sec:survey} reviews the state-of-the-art and the methods compared.
\added[id=old]{
...
%While fewer works have addressed the specific problem of \gls{dme} and its associated feature detection from \gls{oct} images.
...
%  \added[id = old]{Evaluation of the volumetric scan is time consuming, expensive

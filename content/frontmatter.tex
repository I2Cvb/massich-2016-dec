% Article Title
\def \ArticleTitle{Classifying DME vs Normal SD-OCT volumes: A review}
...
\author{
\IEEEauthorblockN{
  \AuthorA\IEEEauthorrefmark{1}\IEEEauthorrefmark{5}\IEEEauthorrefmark{6},
  \AuthorB\IEEEauthorrefmark{1}\IEEEauthorrefmark{5},
  \AuthorC\IEEEauthorrefmark{1}\IEEEauthorrefmark{5},
  \AuthorD\IEEEauthorrefmark{2},
  \\ \AuthorE\IEEEauthorrefmark{2},
  \AuthorF\IEEEauthorrefmark{1},
  \AuthorG\IEEEauthorrefmark{1}\IEEEauthorrefmark{3}
 }
...
\IEEEauthorblockA{\IEEEauthorrefmark{5}Indicates equal contribution. Ordering determined by Rock-Paper-Scissors-Lizard-Spock.}
\IEEEauthorblockA{\IEEEauthorrefmark{6}Corresponding author: \AuthorAemail}
}
